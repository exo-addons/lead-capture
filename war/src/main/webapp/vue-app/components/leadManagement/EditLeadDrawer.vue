            ...
            <form ref="form1">
                <v-row>
                    <v-label for="firstName">
                        {{ $t('exoplatform.editedLeadCapture.editedLeadManagement.firstName','First name') }}
                    </v-label>
                ...
                <v-row>
                    <v-label for="lastName">
                        {{ $t('exoplatform.editedLeadCapture.editedLeadManagement.lastName','Last name') }}
                    </v-label>
                ...
                <v-label for="position">
                        {{ $t('exoplatform.editedLeadCapture.editedLeadManagement.position','Position') }}
                    </v-label>
                ...
                <v-row>
                <v-label for="country">
                        {{ $t('exoplatform.editedLeadCapture.editedLeadManagement.country','Country') }}
                    </v-label>
                ...
                <v-label for="language">
                        {{ $t('exoplatform.editedLeadCapture.editedLeadManagement.language','Language') }}
                    </v-label>
                ...
                <v-label for="geographiqueZone">
                        {{ $t('exoplatform.editedLeadCapture.editedLeadManagement.geographiqueZone','Geographique zone') }}
                    </v-label>
                ...
                <v-label for="marketingSuspendedCause">
                        {{ $t('exoplatform.editedLeadCapture.editedLeadManagement.marketingSuspendedCause','Marketing Suspended Causee') }}
                    </v-label>
