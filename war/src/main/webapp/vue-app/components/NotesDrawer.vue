...
<v-container class="">
     <v-list-item>
        ...
        <a role="button" class="actionIcon" @click="addNote()" style="float: right;">  <i class="uiIconPlus uiIconLightGray"></i> </a>
      </v-list-item>
      <v-list elevation="2">
        <v-list-item  v-for="item in notes"  :key="item.noteMessage">
          <v-list-item-content>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              <v-col >
                <v-textarea solo name="input-7-4" label="Solo textarea"  v-model="newNote.noteMessage"></v-textarea>
              </v-col>
            </v-row>
          </v-container>
        </v-card-text>
